...
var person_Name = "Muhammad Qasim";
// in lower case
...
var favouriteDish = "Biryani";
// revealing my favourite dish in message format.
console.log("My favourite dish is ".concat(favouriteDish, "."));
// Task 11:
// Names: Store the names of a few of your friends in a array called names. Print each person’s name by accessing each element in the list, one at a time.
var names = ["Usman", "Saif", "Umer", "Faizan"];
console.log(names);
// Task 12:
...
var transportation = ["Suzukl Motorcycle", "BMW", "Honda Civic"];
...
var guest_Arr = ["Ali", "Maaz", "Hassan", "Saif"];
...
guest_Arr.map(function (items) { return console.log("Dear ".concat(items, ", you are invited to the dinner.")); });
// Task 16:
...
var guest_arr = ["Ali", "Maaz", "Hassan", "Saif"];
var cannot_attend = "Hassan";
var new_guest = "Hammas";
guest_arr[guest_arr.indexOf(cannot_attend)] = new_guest;
console.log(guest_arr);
guest_arr.map(function (items) { return console.log("Dear ".concat(items, ", I found a bigger dinner table so I am invited to more peoples.")); });
// Part 2: Beginning
var guestBeg = "Zaid";
guest_arr.unshift(guestBeg);
console.log(guest_arr);
// Part 3: Middle
var middleGuest = "Asif";
var middleIndex = guest_arr.length / 3;
...
console.log(guest_arr);
// Part 5:
guest_arr.map(function (items) { return console.log(" Dear ".concat(items, ", you are invited in the more people list on dinner")); });
// Task 17:
...
var placesToVisit = ["Tokyo", "Pakistan", "SaudiaArabia", "America", "Japan"];
...
var country = ["NewYork", "US", "Bangladesh", "England"];
console.log("List of Country:", country);
// TASK 21:
// They think of something you could store in a TypeScript Object. Write a program that creates Objects containing these items.
var person = { name: "Qasim", fname: "Muhammad Zahid", age: 21 };
console.log(person);
// Task 22:
...
var users = ["admin", "ali", "saif", "urroj", "fatima"];
...
var users_name = ["admin", "ali", "saif", "urroj", "fatima"];
users_name = [];
...
var favorite_pizza = ["pepperoni", "chicken", "fajita"];
...
var album = makeAlbum("asif", "light");
console.log(album);
...
var magicians2 = ["noman", "huzaifa", "ali"];
...
var magicians3 = ["noman", "huzaifa", "ali"];
...
var mycar = createcar("honda", "civic", { color: "black", year: "2021" });
console.log(mycar);
